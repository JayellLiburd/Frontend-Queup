...
function Profile() {
    ...
    useEffect(()=>{axios.get('http://localhost:4000/verify/pro', {withCredentials: true}).then((response) => {
    ...
    const update = () => {axios.get('http://localhost:4000/verify/pro', {withCredentials: true}).then((response) => {
