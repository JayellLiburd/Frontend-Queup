...
function Profile() {
    ...
    useEffect(()=>{axios.get('https://api.queueupnext.com/verify/pro', {withCredentials: true}).then((response) => {
    ...
    const update = () => {axios.get('https://api.queueupnext.com/verify/pro', {withCredentials: true}).then((response) => {
