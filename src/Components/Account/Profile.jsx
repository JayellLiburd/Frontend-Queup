...
function Profile() {
    ...
    useEffect(()=>{axios.get('https://queueupnext.com/verify/pro', {withCredentials: true}).then((response) => {
    ...
    const update = () => {axios.get('https://queueupnext.com/verify/pro', {withCredentials: true}).then((response) => {
